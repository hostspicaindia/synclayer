...
export default function NPMSDKs() {
    return (
            ...
            <section className="px-6 pt-24 pb-32">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-xs font-medium mb-6">
                        <SiNpm className="w-3 h-3 text-[#CB3837]" />
                        <span>NPM Platform</span>
                    </div>
                    ...
                    <p className="text-lg text-gray-700 mb-12 max-w-2xl mx-auto leading-relaxed">
                        Production-ready NPM packages for modern web development. Coming soon.
                    </p>

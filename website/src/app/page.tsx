          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-10 shadow-sm">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-sm text-gray-600 font-mono mb-6">v0.2.0-beta.5</p>

                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Enterprise-grade local-first sync engine for Flutter. Build offline-first apps with automatic
                  synchronization, conflict resolution, and real-time updates.
                </p>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <FeatureItem text="Event-Driven System" />
                  <FeatureItem text="Isar-Powered Storage" />
                  <FeatureItem text="Type-Safe API" />
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <MetricItem label="Package Size" value="312 KB" />
                    <MetricItem label="Tests Passing" value="48" />
      ...
      <section className="px-6 py-20">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <StatCard value="48" label="Tests Passing" sublabel="Comprehensive coverage" />

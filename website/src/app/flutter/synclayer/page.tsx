        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-200 text-green-700 rounded-full text-sm font-medium">
              ...
              <span className="font-mono">v0.2.0-beta.5</span>
          ...
          <p className="text-xl text-gray-700 text-center mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            powered by event-driven architecture, designed for mission-critical applications.
          </p>

          {/* Metrics */}
          <div className="flex flex-wrap items-center justify-center gap-6 mb-12">
            <MetricBadge icon={<CheckCircle2 className="w-4 h-4 text-green-600" />} label="48 Tests Passing" />
            <MetricBadge icon={<CheckCircle2 className="w-4 h-4 text-green-600" />} label="160/160 Pub Score" />
            <MetricBadge icon={<CheckCircle2 className="w-4 h-4 text-green-600" />} label="312 KB Package" />
            <MetricBadge icon={<CheckCircle2 className="w-4 h-4 text-green-600" />} label="5 Platforms" />
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <ArchitectureBlock
                ...
                items={['Event-Driven', 'Conflict Resolution', 'Auto-Retry Logic']}
                highlight
              />
              <ArchitectureBlock
...
await SyncLayer
  ...
  .delete(id);`}
            ...
            <div>
              <h3 className="text-lg font-bold text-black mb-3">Real-time Updates</h3>
              <CodeBlock
                language="dart"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <TechFeature
              ...
              description="Lightning-fast local database with zero-copy object access and ACID compliance"
              metrics={['< 1ms queries', 'NoSQL flexibility', 'Type-safe']}
            />
            <TechFeature
              icon={<Cpu className="w-8 h-8 text-purple-600" />}
              title="Event-Driven Architecture"
              description="Reactive sync engine with comprehensive event system for monitoring and debugging"
              metrics={['Real-time events', 'Full observability', 'Error tracking']}
            />
            <TechFeature
      ...
      <section className="px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-12">
            <h2 className="text-3xl font-bold text-center text-black mb-12">Performance Benchmarks</h2>
            <div className="grid md:grid-cols-4 gap-8">
              <PerformanceMetric
                value="< 5s"
                label="Save 100 Records"
                description="Individual operations"
              />
              <PerformanceMetric
                value="< 1s"
                label="Retrieve 100 Records"
                description="Batch queries"
              />
              <PerformanceMetric
                value="< 3s"
                label="Delete 100 Records"
                description="Bulk operations"
              />
              <PerformanceMetric
                value="< 10s"
                label="Sync 100 Operations"
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <ComparisonRow feature="Package Size" synclayer="312 KB" firebase="~2 MB" supabase="~1.5 MB" drift="~500 KB" />
